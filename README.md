...
- All work is done in SQL( PostgreSQL). 



### Instructions

- Creating a SQL database using the attached CSV files.
- Using the database to answer the following questions.
- All answers that return money values are rounded to 2 decimal points and preceded by the "$" symbol (e.g. "$1432.10").
- All answers that return percent values are between -100.00 to 100.00, rounded to 2 decimal points and followed by the "%" symbol (e.g. "58.30%").
